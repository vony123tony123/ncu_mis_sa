...
public class Member {
	 ...
	 * @param address      會員地址
	 */
	public Member(String id, String name, String email, String password, String bank_account, String birthday,
			int gender, int height, int weight, int disease_id, String phone_number, String address) {
		this.id = id;
		this.name = name;
		this.email = email;
	 ...
	 * 
	 */
	public Member(String name, String email, String password, String bank_account, String birthday, int gender,
			int height, int weight, int disease_id, String phone_number, String address, int manager, int delete_key) {
		this.name = name;
		this.email = email;
		this.password = password;
		this.bank_account = bank_account;
	...
	/**
	 * 此建構子用於 取得會員資料 時，將每一筆資料新增為一個會員物件
	 *
	 * @param id           會員編號
	 * @param email        會員電子信箱
	 * @param password     會員密碼
	 ...
	 */
	public Member(String id, String name, String email, String password, String bank_account, String birthday,
			int gender, int height, int weight, int disease_id, String phone_number, String address, int manager,
			int delete_key) {
		this.id = id;
		this.name = name;
		this.email = email;
