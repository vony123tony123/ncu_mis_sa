...
public class MemberHelper {
    ...
    public JSONObject 				deleteByID(
        ...
        try {
             ...
             * SQL指令
             */
            String 					sql 			= "DELETE FROM `missa`.`member` "
    ...
    public JSONObject 				create(
        ...
        try {
             ...
             * QL指令
             */
            String 					sql 			= "INSERT INTO `missa`.`member`"
            										+ "("
            										+ "`ID_number`, "
            										+ "`name`, "
            										+ "`email`, "
    ...
    public JSONObject 				update(
        ...
        try {
             ...
             * SQL指令
             */
            String 					sql 			= " Update `missa`.`member` SET "
            										+ "`name` = ? , "
            										+ "`email` = ? , "
            										+ "`password` = ? , "
            										+ "`bank_account` = ? , "
