...
public class MemberController extends HttpServlet {
    ...
    public void 					doPost(
        ...
        if (						id.isEmpty() 			|| 
             ...
             * 以字串組出JSON格式之資料
             */
            String 					resp 			= "{\"status\": \'400\', \"message\": "
            										+ "\'欄位不能有空值\', \'response\': "
            										+ "\'\'}";
            /**
    ...
    public void 					doPut(
        ...
        /**
         * 透過Member物件的update()方法至資料庫更新該名會員資料，
         * 回傳之資料為JSONObject物件 
         */
    ...
    public void 					doGet(
        ...
        JsonReader 					jsr 			= new JsonReader(request);
        /**
         * 若直接透過前端AJAX之data以key=value之字串方式進行傳遞參數，
         * 可以直接由此方法取回資料
         */
        String 						id 				= jsr.getParameter("id");
        /**
         * 判斷該字串是否存在，若存在代表要取回個別會員之資料，
         * 否則代表要取回全部資料庫內會員之資料
         */
        if (id.isEmpty()) {
            /**
             * 透過MemberHelper物件之getAll()方法取回所有會員之資料，
             * 回傳之資料為JSONObject物件
             */
            ...
            /**
             * 透過MemberHelper物件的getByID()方法自資料庫取回該名會員之資料，
             * 回傳之資料為JSONObject物件
             */
    ...
    public void 					doDelete(
        ...
        String 						id 				= jso.getString("id");
        /**
         * 透過MemberHelper物件的deleteByID()方法至資料庫刪除該名會員，
         * 回傳之資料為JSONObject物件 
         */
